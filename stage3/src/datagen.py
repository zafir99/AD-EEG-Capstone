...
a_channel_avg = psd_channel_avgs[alzheimers[0]-1:alzheimers[1]].mean(axis=2)
c_channel_avg = psd_channel_avgs[control[0]-1:control[1]].mean(axis=2)

a_fname = out_folder / "alz_channel_band_avg.csv"
c_fname = out_folder / "con_channel_band_avg.csv"
af = open(a_fname, "wt")
cf = open(c_fname, "wt")
af.write("Delta_Power,Theta_Power,Alpha_Power,Beta_Power\n")
cf.write("Delta_Power,Theta_Power,Alpha_Power,Beta_Power\n")
